...
######################################Shard: A##################################
if [[ $TAG_NAME_VALUE =~ gandalf-a[0-9]-2[b-c]$ ]]; then
...
##############################Shard: B###########################################
if [[ $TAG_NAME_VALUE =~ gandalf-b[0-9]-2[b-c]$ ]]; then
...
##############################Shard: C###########################################
if [[ $TAG_NAME_VALUE =~ gandalf-c[0-9]-2[b-c]$ ]]; then
...
##############################Shard: D###########################################
if [[ $TAG_NAME_VALUE =~ gandalf-d[0-9]-2[b-c]$ ]]; then
...
##############################Shard: E###########################################
if [[ $TAG_NAME_VALUE =~ gandalf-e[0-9]-2[b-c]$ ]]; then
...
##############################Shard: F###########################################
if [[ $TAG_NAME_VALUE =~ gandalf-f[0-9]-2[b-c]$ ]]; then
...
##############################Shard: G###########################################
if [[ $TAG_NAME_VALUE =~ gandalf-g[0-9]-2[b-c]$ ]]; then
...
##############################Shard: H###########################################
if [[ $TAG_NAME_VALUE =~ gandalf-h[0-9]-2[b-c]$ ]]; then
...
##############################Shard: I###########################################
if [[ $TAG_NAME_VALUE =~ gandalf-i[0-9]-2[b-c]$ ]]; then
...
##############################Shard: J###########################################
if [[ $TAG_NAME_VALUE =~ gandalf-j[0-9]-2[b-c]$ ]]; then
...
##############################Shard: K###########################################
if [[ $TAG_NAME_VALUE =~ gandalf-k[0-9]-2[b-c]$ ]]; then
...
##############################Shard: L###########################################
if [[ $TAG_NAME_VALUE =~ gandalf-l[0-9]-2[b-c]$ ]]; then
...
##############################Shard: M###########################################
if [[ $TAG_NAME_VALUE =~ gandalf-m[0-9]-2[b-c]$ ]]; then
...
##############################Shard: N###########################################
if [[ $TAG_NAME_VALUE =~ gandalf-n[0-9]-2[b-c]$ ]]; then
...
##############################Shard: O###########################################
if [[ $TAG_NAME_VALUE =~ gandalf-o[0-9]-2[b-c]$ ]]; then
...
##############################Shard: P###########################################
if [[ $TAG_NAME_VALUE =~ gandalf-p[0-9]-2[b-c]$ ]]; then
...
##############################Shard: Q###########################################
if [[ $TAG_NAME_VALUE =~ gandalf-q[0-9]-2[b-c]$ ]]; then
...
##############################Shard: R###########################################
if [[ $TAG_NAME_VALUE =~ gandalf-r[0-9]-2[b-c]$ ]]; then
