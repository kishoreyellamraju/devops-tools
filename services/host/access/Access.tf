resource "aws_instance" "spark-access01-2b" {
	ami                         = "${var.ami}"
	ebs_optimized               = true
...
resource "aws_instance" "prod-access01-2c" {
	ami                         = "${var.ami}"
	ebs_optimized               = false
...
resource "aws_instance" "prod-access01-2b" {
	ami                         = "${var.ami}"
	ebs_optimized               = false
	instance_type               = "t2.medium"
	monitoring                  = false
